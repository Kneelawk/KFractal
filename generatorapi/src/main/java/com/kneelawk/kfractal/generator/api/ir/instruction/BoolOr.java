 ...
 */
public class BoolOr implements IProceduralValue {
    private IProceduralValue left;
    private IProceduralValue right;

    private BoolOr(IProceduralValue left, IProceduralValue right) {
        this.left = left;
        this.right = right;
    }
    ...
    public static BoolOr create(IProceduralValue left,
