...
/**
 * BoolIsEqual - Instruction. Checks to see if the two boolean arguments are equal. This is the same as a boolean XNOR.
 * <p>
 * BoolIsEqual(Bool left, Bool right)
 */
public class BoolIsEqual implements IProceduralValue {
    private IProceduralValue left;
    private IProceduralValue right;

    private BoolIsEqual(IProceduralValue left, IProceduralValue right) {
        this.left = left;
        this.right = right;
    }
    ...
    public <R> R accept(IProceduralValueVisitor<R> visitor) throws FractalException {
        return visitor.visitBoolIsEqual(this);
    }
    ...
    public static BoolIsEqual create(IProceduralValue left,
        ...
        return new BoolIsEqual(left, right);
    }
