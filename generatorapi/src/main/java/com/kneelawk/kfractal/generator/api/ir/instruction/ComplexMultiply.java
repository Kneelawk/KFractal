 ...
 */
public class ComplexMultiply implements IValue {
    private IValue leftFactor;
    private IValue rightFactor;

    private ComplexMultiply(IValue leftFactor, IValue rightFactor) {
    ...
    public static ComplexMultiply create(IValue leftFactor,
                                         IValue rightFactor) {
        if (leftFactor == null)
