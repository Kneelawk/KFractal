...
/**
 * ComplexMultiply - Instruction. Multiplies the two complex numbers.
 * <p>
 * ComplexMultiply(Complex a, Complex b)
 */
public class ComplexMultiply implements IProceduralValue {
    private IProceduralValue leftFactor;
    private IProceduralValue rightFactor;

    private ComplexMultiply(IProceduralValue leftFactor, IProceduralValue rightFactor) {
    ...
    public static ComplexMultiply create(IProceduralValue leftFactor,
        ...
        return new ComplexMultiply(leftFactor, rightFactor);
    }
