 ...
 */
public class IntModulo implements IProceduralValue {
    private IProceduralValue left;
    private IProceduralValue right;

    private IntModulo(IProceduralValue left, IProceduralValue right) {
        this.left = left;
        this.right = right;
    }
    ...
    public static IntModulo create(IProceduralValue left,
